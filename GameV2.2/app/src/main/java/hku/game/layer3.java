...
public class layer3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = R.id.image11;
        mediaPlayer2=MediaPlayer.create(layer3.this,R.raw.backgroundmusic1);
        mediaPlayer2.start();
        ...
        restart.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                count.cleanImages();
                Intent intent2 = new Intent(layer3.this, layer1.class);
...
//                            txt.setText("Game Over!");
                            ...
                            Intent intent1 = new Intent(layer3.this, LoginPage.class);
                            mediaPlayer2.stop();
        ...
        right.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                if (y1 == 3 && x1 == 0) {}
                    ...
                    Intent intent = new Intent(layer3.this, showUser.class);
                    saveGame();
                    count.cleanImages();
                    MediaPlayer mediaPlayerwin;
                    mediaPlayerwin=MediaPlayer.create(layer3.this,R.raw.greatmusic);
...
//                            txt.setText("Game Over!");
    ...
    public void saveGame(){
        ...
        user player= new user(playerName, playerPassword, playerId,2);
